            ...
            <table class="table-auto w-full">
                <thead>
                    <tr class="text-xs text-gray-500 text-left">
                        <th class="font-medium px-4">名前</th>
                ...
                <tbody>
                    ...
                    <tr @class(['text-sm', 'bg-gray-50'=> $loop->odd])>
                        <td class="flex px-4 py-3 items-center">
                            <img class="w-12 h-12 mr-4 object-cover rounded-full"
                                src="{{ asset('storage/'.$user->image) }}" alt="">
                            <p class="font-medium"><a
                                    href="{{ route('admin.users.edit', ['user' => $user]) }}">{{ $user->name }}</a>
                            </p>
                        </td>
                        ...
                        <td>
                            <div class="flex">
                                <a class="mr-2" href="{{ route('admin.users.edit', ['user' => $user]) }}">
